...
void ShipMuonShield::ConstructGeometry()
{
	...
	absorber_magnet_components +=
      ...
      std::array<double, 9> fieldScale = {{1., 1., 1.294, 0.9523176379, 0.9523176379, 0.9523176379, 0.9523176379, 0.9523176379, 0.9523176379}};
      for (Int_t nM = 2; nM <= (nMagnets - 1); nM++) {
      	ironField = fField * fieldScale[nM] * tesla;
      TGeoUniformMagField *magFieldIron_my = new TGeoUniformMagField(0.,ironField,0.);
      TGeoUniformMagField *RetField_my     = new TGeoUniformMagField(0.,-ironField,0.);
      TGeoUniformMagField *ConRField_my    = new TGeoUniformMagField(-ironField,0.,0.);
      TGeoUniformMagField *ConLField_my    = new TGeoUniformMagField(ironField,0.,0.);
      TGeoUniformMagField *fields_my[4] = {magFieldIron_my,RetField_my,ConRField_my,ConLField_my};
      std::cout<<"Creating magnet "<< magnetName[nM]<<"	z = "<<dZf[nM]<<" fieldScale "<<fieldScale[nM]<<"fieldValue: "<<ironField/tesla<<std::endl;
