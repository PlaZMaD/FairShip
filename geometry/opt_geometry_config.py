...
# size of straws
 ...
 #HPT
    ...
    c.SensPlane.z_1 = -(c.decayVolume.length)/2. + 1.*u.m - c.muShield.LE #c.muShield.z + 1*u.m - c.muShield.length / 2 + c.muShield.LE + 22.26 *2.*u.cm + 0.35 *2.**u.cm +  (2.*6.*300**u.cm + 2*6 * c.muShield.dZgap)