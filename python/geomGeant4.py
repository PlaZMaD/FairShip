...
def addVMCFields(shipGeo, controlFile = '', verbose = False, withVirtualMC = True):
    ...
    if hasattr(shipGeo, 'Bfield'):
      ...
      # set SC field map
      fieldMaker.defineFieldMap('SCMap','files/SCFieldMap_comsol_invert.root', ROOT.TVector3(0.0,0.0, ShieldUtils.sc_center(shipGeo)), ROOT.TVector3(0.0,0.0, 0.0), True)
